...
export class SidebarComponent {
  ...
  { icon: 'assets/menu/appointments-icon.svg', label: 'Appointments', route: '/appointment' },  // NEW
  { icon: 'assets/menu/complaints-icon.svg', label: 'Complaints', route: '/complaint' },        // NEW
